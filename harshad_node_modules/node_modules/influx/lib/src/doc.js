 ...
 * })
 */
var IResults = (function (_super) {
    __extends(IResults, _super);
    function IResults() {
     ...
     * })
     */
    IResults.prototype.group = function (matcher) { return null; };
    /**
     ...
     * })
     */
    IResults.prototype.groups = function () { return null; };
    return IResults;
}(Array));
 ...
 * console.log(backoff.getDelay()); // => 10
 */
var IBackoffStrategy = (function () {
    function IBackoffStrategy() {
    }
    /**
     * getDelay returns the amount of delay of the current backoff.
     * @return {Number}
     */
    IBackoffStrategy.prototype.getDelay = function () { return 0; };
    /**
     * Next is called when a failure occurs on a host to
     * return the next backoff amount.
     * @return {IBackoffStrategy}
     */
    IBackoffStrategy.prototype.next = function () { return this; };
    /**
     * Returns a strategy with a reset backoff counter.
     * @return {IBackoffStrategy}
     */
    IBackoffStrategy.prototype.reset = function () { return this; };
    return IBackoffStrategy;
}());
exports.IBackoffStrategy = IBackoffStrategy;
/**
 ...
 * @interface
 */
var INanoDate = (function (_super) {
    __extends(INanoDate, _super);
    function INanoDate() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    /**
     ...
     */
    INanoDate.prototype.getNanoTime = function () { return ''; };
    ;
    /**
     ...
     */
    INanoDate.prototype.toNanoISOString = function () { return ''; };
    ;
    return INanoDate;
}(Date));
exports.INanoDate = INanoDate;
