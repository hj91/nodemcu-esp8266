// --------- This code has been automatically generated !!! 2018-04-16T04:56:45.607Z
"use strict";
/**
...
const schema = require("../schemas/SessionSecurityDiagnostics_schema").SessionSecurityDiagnostics_Schema;
 ...
 * @param stream {BinaryStream} 
 */
SessionSecurityDiagnostics.prototype.decode = function(stream) {
    // call base class implementation first
    BaseUAObject.prototype.decode.call(this,stream);
    this.sessionId = decode_NodeId(stream);
    this.clientUserIdOfSession = decode_String(stream);
    this.clientUserIdHistory = decode_String(stream);
    this.authenticationMechanism = decode_String(stream);
    this.encoding = decode_String(stream);
    this.transportProtocol = decode_String(stream);
