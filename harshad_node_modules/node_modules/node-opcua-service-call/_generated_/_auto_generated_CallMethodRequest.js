// --------- This code has been automatically generated !!! 2018-04-16T04:56:39.447Z
"use strict";
/**
...
const schema = require("../schemas/CallMethodRequest_schema").CallMethodRequest_Schema;
...
function CallMethodRequest(options)
{
    ...
    if (options === null) { 
        BaseUAObject.call(this,options);
        self.inputArguments =  null; /* null array */
        return ;
    }
 ...
 * @param stream {BinaryStream} 
 */
CallMethodRequest.prototype.decode = function(stream) {
    // call base class implementation first
    BaseUAObject.prototype.decode.call(this,stream);
    this.objectId = decode_NodeId(stream);
    this.methodId = decode_NodeId(stream);
