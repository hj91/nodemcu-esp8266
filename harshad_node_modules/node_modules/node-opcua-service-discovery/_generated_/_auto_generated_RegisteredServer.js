// --------- This code has been automatically generated !!! 2018-05-31T21:06:04.354Z
"use strict";
/**
...
const schema = require("../schemas/RegisteredServer_schema").RegisteredServer_Schema;
...
function RegisteredServer(options)
{
    ...
    if (options === null) { 
        BaseUAObject.call(this,options);
        self.serverNames =  null; /* null array */
        return ;
    }
 ...
 * @param stream {BinaryStream} 
 */
RegisteredServer.prototype.decode = function(stream) {
    // call base class implementation first
    ...
    this.serverNames = decodeArray(stream, function(stream) { 
       const obj = new LocalizedText(null);
       obj.decode(stream);
       return obj; 
    });
    this.serverType = decode_ApplicationType(stream);
    this.gatewayServerUri = decode_String(stream);
    this.discoveryUrls = decodeArray(stream, decode_String);
    this.semaphoreFilePath = decode_String(stream);
    this.isOnline = decode_Boolean(stream);
};
