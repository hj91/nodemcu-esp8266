// --------- This code has been automatically generated !!! 2018-04-16T04:56:51.419Z
"use strict";
/**
...
const schema = require("../schemas/AggregateConfiguration_schema").AggregateConfiguration_Schema;
 ...
 * @param stream {BinaryStream} 
 */
AggregateConfiguration.prototype.decode = function(stream) {
    // call base class implementation first
    BaseUAObject.prototype.decode.call(this,stream);
    this.useServerCapabilitiesDefaults = decode_Boolean(stream);
    this.treatUncertainAsBad = decode_Boolean(stream);
    this.percentDataBad = decode_Byte(stream);
    this.percentDataGood = decode_Byte(stream);
    this.useSlopedExtrapolation = decode_Boolean(stream);
};
