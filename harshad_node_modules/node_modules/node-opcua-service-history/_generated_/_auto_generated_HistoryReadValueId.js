// --------- This code has been automatically generated !!! 2018-04-16T04:56:51.447Z
"use strict";
/**
...
const schema = require("../schemas/HistoryReadValueId_schema").HistoryReadValueId_Schema;
 ...
 * @param stream {BinaryStream} 
 */
HistoryReadValueId.prototype.decode = function(stream) {
    // call base class implementation first
    BaseUAObject.prototype.decode.call(this,stream);
    this.nodeId = decode_NodeId(stream);
    this.indexRange = decode_String(stream);
    this.dataEncoding.decode(stream);
    this.continuationPoint = decode_ByteString(stream);
};
