// --------- This code has been automatically generated !!! 2018-04-16T04:56:58.305Z
"use strict";
/**
...
const schema = require("../schemas/QueryFirstResponse_schema").QueryFirstResponse_Schema;
...
const QueryDataSet = require("./_auto_generated_QueryDataSet").QueryDataSet;
const ParsingResult = require("./_auto_generated_ParsingResult").ParsingResult;
const DiagnosticInfo = getFactory("DiagnosticInfo");
const ContentFilterResult = getFactory("ContentFilterResult");
...
function QueryFirstResponse(options)
{
    ...
    if (options === null) { 
        ...
        self.queryDataSet =  null; /* null array */
        self.parsingResult =  null; /* null array */
        self.diagnosticInfos =  null; /* null array */
        self.filterResult =  null; /* new ContentFilterResult(null); */
        return ;
    }
 ...
 * @param stream {BinaryStream} 
 */
QueryFirstResponse.prototype.decode = function(stream) {
    // call base class implementation first
