// --------- This code has been automatically generated !!! 2018-04-16T04:56:45.568Z
"use strict";
/**
...
const schema = require("../schemas/ReadRequest_schema").ReadRequest_Schema;
...
const ReadValueId = require("./_auto_generated_ReadValueId").ReadValueId;
 ...
 * @param stream {BinaryStream} 
 */
ReadRequest.prototype.decode = function(stream) {
    // call base class implementation first
    BaseUAObject.prototype.decode.call(this,stream);
    this.requestHeader.decode(stream);
    this.maxAge = decode_Duration(stream);
