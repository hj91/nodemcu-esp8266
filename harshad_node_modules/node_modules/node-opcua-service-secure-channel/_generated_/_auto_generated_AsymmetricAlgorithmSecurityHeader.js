// --------- This code has been automatically generated !!! 2018-04-16T04:56:36.191Z
"use strict";
/**
...
const schema = require("../schemas/AsymmetricAlgorithmSecurityHeader_schema").AsymmetricAlgorithmSecurityHeader_Schema;
 ...
 * @param stream {BinaryStream} 
 */
AsymmetricAlgorithmSecurityHeader.prototype.decode = function(stream) {
    // call base class implementation first
    BaseUAObject.prototype.decode.call(this,stream);
    this.securityPolicyUri = decode_String(stream);
    this.senderCertificate = decode_ByteString(stream);
    this.receiverCertificateThumbprint = decode_ByteString(stream);
};
