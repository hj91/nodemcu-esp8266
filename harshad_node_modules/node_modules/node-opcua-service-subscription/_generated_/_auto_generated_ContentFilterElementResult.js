// --------- This code has been automatically generated !!! 2018-04-16T04:56:54.870Z
"use strict";
/**
...
const schema = require("../schemas/ContentFilterElementResult_schema").ContentFilterElementResult_Schema;
...
function ContentFilterElementResult(options)
{
    ...
    if (options === null) { 
        BaseUAObject.call(this,options);
        self.operandDiagnosticInfos =  null; /* new DiagnosticInfo(null); */
        return ;
    }
 ...
 * @param stream {BinaryStream} 
 */
ContentFilterElementResult.prototype.decode = function(stream) {
    // call base class implementation first
    BaseUAObject.prototype.decode.call(this,stream);
    this.statusCode = decode_StatusCode(stream);
    this.operandStatusCodes = decode_StatusCode(stream);
    this.operandDiagnosticInfos.decode(stream);
};
