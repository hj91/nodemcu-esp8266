// --------- This code has been automatically generated !!! 2018-04-16T04:56:54.629Z
"use strict";
/**
...
const schema = require("../schemas/ModifySubscriptionRequest_schema").ModifySubscriptionRequest_Schema;
 ...
 * @param stream {BinaryStream} 
 */
ModifySubscriptionRequest.prototype.decode = function(stream) {
    // call base class implementation first
    ...
    this.requestedPublishingInterval = decode_Duration(stream);
    this.requestedLifetimeCount = decode_Counter(stream);
    this.requestedMaxKeepAliveCount = decode_Counter(stream);
    this.maxNotificationsPerPublish = decode_Counter(stream);
