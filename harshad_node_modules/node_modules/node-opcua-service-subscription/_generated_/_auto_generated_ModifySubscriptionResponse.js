// --------- This code has been automatically generated !!! 2018-04-16T04:56:54.638Z
"use strict";
/**
...
const schema = require("../schemas/ModifySubscriptionResponse_schema").ModifySubscriptionResponse_Schema;
 ...
 * @param stream {BinaryStream} 
 */
ModifySubscriptionResponse.prototype.decode = function(stream) {
    // call base class implementation first
    BaseUAObject.prototype.decode.call(this,stream);
    this.responseHeader.decode(stream);
    this.revisedPublishingInterval = decode_Duration(stream);
    this.revisedLifetimeCount = decode_Counter(stream);
    this.revisedMaxKeepAliveCount = decode_Counter(stream);
};
