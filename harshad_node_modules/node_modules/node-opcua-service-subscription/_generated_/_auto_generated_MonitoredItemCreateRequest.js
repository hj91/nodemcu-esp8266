// --------- This code has been automatically generated !!! 2018-04-16T04:56:54.652Z
"use strict";
/**
...
const schema = require("../schemas/MonitoredItemCreateRequest_schema").MonitoredItemCreateRequest_Schema;
const getFactory = require("node-opcua-factory/src/factories_factories").getFactory;
const ReadValueId = getFactory("ReadValueId");
const MonitoringParameters = require("./_auto_generated_MonitoringParameters").MonitoringParameters;
...
function MonitoredItemCreateRequest(options)
{
    ...
    if (options === null) { 
        BaseUAObject.call(this,options);
        self.itemToMonitor =  null; /* new ReadValueId(null); */
        self.requestedParameters =  null; /* new MonitoringParameters(null); */
        return ;
    }
 ...
 * @param stream {BinaryStream} 
 */
MonitoredItemCreateRequest.prototype.decode = function(stream) {
    // call base class implementation first
