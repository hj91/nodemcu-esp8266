// --------- This code has been automatically generated !!! 2018-04-16T04:56:54.699Z
"use strict";
/**
...
const schema = require("../schemas/PublishResponse_schema").PublishResponse_Schema;
...
const NotificationMessage = require("./_auto_generated_NotificationMessage").NotificationMessage;
...
function PublishResponse(options)
{
    ...
    if (options === null) { 
        ...
        self.notificationMessage =  null; /* new NotificationMessage(null); */
 ...
 * @param stream {BinaryStream} 
 */
PublishResponse.prototype.decode = function(stream) {
    // call base class implementation first
    ...
    this.moreNotifications = decode_Boolean(stream);
