// --------- This code has been automatically generated !!! 2018-04-16T04:56:54.830Z
"use strict";
/**
...
const schema = require("../schemas/StatusChangeNotification_schema").StatusChangeNotification_Schema;
...
function StatusChangeNotification(options)
{
    ...
    if (options === null) { 
        BaseUAObject.call(this,options);
        self.diagnosticInfo =  null; /* new DiagnosticInfo(null); */
        return ;
    }
 ...
 * @param stream {BinaryStream} 
 */
StatusChangeNotification.prototype.decode = function(stream) {
    // call base class implementation first
    BaseUAObject.prototype.decode.call(this,stream);
    this.statusCode = decode_StatusCode(stream);
    this.diagnosticInfo.decode(stream);
};
