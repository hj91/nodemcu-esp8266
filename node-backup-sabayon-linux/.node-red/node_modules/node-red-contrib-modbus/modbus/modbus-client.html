...
<label for='node-config-input-tcpHost'><i class='icon-bookmark'></i> <span data-i18n='modbus-contrib.label.host'>
</span></label> <input type='text' id='node-config-input-tcpHost'> </div> <div class='form-row'> <label 
...
Serial Port (/dev/tty.usbserial | COM[1..n])</li> <li>Serial Baud rate</li> <li>Serial Databits</li> <li>
Serial Stopbits</li> <li>Serial Parity</li> <li>Serial Type</li> <li>
