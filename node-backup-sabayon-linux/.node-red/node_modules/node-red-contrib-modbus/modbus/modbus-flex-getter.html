...
id='node-input-ioFile'> </div> </div> </script> <script type='text/x-red' data-help-name='modbus-flex-getter'>
...
unitid (0..255 tcp | 1..247 serial) - overrides default Unit-ID</li> <li>fc (1..4)</li> <li>start address (0:65535)
</li> <li>quantity (1:65535) of coils/inputs/registers to be read from the start address</li> </ul> <p></p> <p>
