...
id='modbus-server-tab-settings' style='display:none'> <div class='form-row'> <label for='node-input-name'><i 
class='icon-tag'></i> Name</label> <input type='text' id='node-input-name' placeholder='Name'> </div> <div 
class='form-row'> <label for='node-input-serverAddress'><i class='icon-tag'></i> <span 
data-i18n='modbus-contrib.label.address'></span></label> <input type='text' id='node-input-serverAddress' 
...
id='node-input-serverPort' placeholder='2000 to 65536'> </div> <div class='form-row'> <label 
for='node-input-responseDelay'><i class='icon-tag'></i> <span data-i18n='modbus-contrib.label.responseDelay'></span>
</label> <input type='text' id='node-input-responseDelay' placeholder='100' style='max-width:120px'> <select 
id='node-input-delayUnit' style='max-width:160px'> <option value='ms'>millisecond(s)</option> <option value='s'>
second(s)</option> <option value='m'>minute(s)</option> <option value='h'>hour(s)</option> </select> </div> <div 
class='form-row'> <label for='node-input-unitId'><i class='icon-tag'></i> <span 
...
placeholder='20000'> </div> <div class='form-row'> <label for='node-input-registersBufferSize'><i class='icon-tag'></i>
 <span data-i18n='modbus-contrib.label.registers'></span></label> <input type='text' 
id='node-input-registersBufferSize' placeholder='20000'> </div> <hr> <div class='form-row'> <label 
for='node-input-minAddress'><i class='icon-tag'></i> <span data-i18n='modbus-contrib.label.minAddress'></span></label> 
<input type='text' id='node-input-minAddress' placeholder='0'> </div> <div class='form-row'> <label 
for='node-input-splitAddress'><i class='icon-tag'></i> <span data-i18n='modbus-contrib.label.splitAddress'></span>
 ...
 style='min-width:160px' for='node-input-logEnabled'><i class='fa fa-th'></i> <span 
data-i18n='modbus-contrib.label.logEnabled'></span></label> <input type='checkbox' id='node-input-logEnabled' 
style='max-width:30px'> </div> </div> <div id='modbus-server-tab-getCoil' style='display:none'> <div class='form-row' 
style='margin-bottom:0'> <label for='node-input-funcGetCoil'><i class='fa fa-wrench'></i> <span 
data-i18n='function.label.function'></span></label> <input type='hidden' id='node-input-funcGetCoil'> </div> <div 
class='form-row node-text-editor-row'> <div style='height:250px;min-height:150px' class='node-text-editor' 
id='node-input-func-editor-getCoil'></div> </div> </div> <div id='modbus-server-tab-getInput' style='display:none'> 
<div class='form-row' style='margin-bottom:0'> <label for='node-input-funcGetInputRegister'><i class='fa fa-wrench'>
</i> <span data-i18n='function.label.function'></span></label> <input type='hidden' 
id='node-input-funcGetInputRegister'> </div> <div class='form-row node-text-editor-row'> <div 
style='height:250px;min-height:150px' class='node-text-editor' id='node-input-func-editor-getInputRegister'></div> 
</div> </div> <div id='modbus-server-tab-getHolding' style='display:none'> <div class='form-row' 
style='margin-bottom:0'> <label for='node-input-funcGetHoldingRegister'><i class='fa fa-wrench'></i> <span 
data-i18n='function.label.function'></span></label> <input type='hidden' id='node-input-funcGetHoldingRegister'> </div>
 <div class='form-row node-text-editor-row'> <div style='height:250px;min-height:150px' class='node-text-editor' 
id='node-input-func-editor-getHoldingRegister'></div> </div> </div> <div id='modbus-server-tab-setCoil' 
style='display:none'> <div class='form-row' style='margin-bottom:0'> <label for='node-input-funcSetCoil'><i 
class='fa fa-wrench'></i> <span data-i18n='function.label.function'></span></label> <input type='hidden' 
id='node-input-funcSetCoil'> </div> <div class='form-row node-text-editor-row'> <div 
...
</p> <p>Output 2: coils Buffer, type, msg</p> <p>Output 3: input Buffer, type, msg</p> </script> 