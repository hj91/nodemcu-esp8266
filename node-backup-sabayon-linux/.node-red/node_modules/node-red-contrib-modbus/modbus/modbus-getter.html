...
--> <script type='text/javascript'> RED.nodes.registerType('modbus-getter', {
 ...
 <div class='form-row'> <ul style='background:#fff;min-width:600px;margin-bottom:20px' id='node-input-modbus-tabs'>
</ul> </div> <div id='node-input-tabs-content' style='min-height:170px'> <div id='modbus-settings-tab' 
style='display:none'> <div class='form-row'> <label for='node-input-name'><i class='icon-tag'></i> <span 
...
FC 3: Read Holding Registers</option> <option value='InputRegister'>FC 4: Read Input Registers</option> </select> 
</div> <div class='form-row'> <label for='node-input-adr'><i class='icon-home'></i> <span 
...
style='max-width:30px'> </div> <hr> <div class='form-row'> <label style='min-width:160px' for='node-input-useIOFile'><i
 class='fa fa-file-code-o'></i> <span data-i18n='modbus-contrib.label.useIOFile'></span></label> <input 
type='checkbox' id='node-input-useIOFile' style='max-width:30px'> </div> <div id='modbusiofile-row'> <div 
class='form-row'> <label style='min-width:160px' for='node-input-useIOForPayload'><i class='fa fa-comment-o'></i> <span
 data-i18n='modbus-contrib.label.useIOForPayload'></span></label> <input type='checkbox' 
id='node-input-useIOForPayload' style='max-width:30px'> </div> <div class='form-row'> <label for='node-input-ioFile'><i
 class='icon-file'></i> <span data-i18n='modbus-contrib.label.ioFile'></span></label> <input type='text' 
id='node-input-ioFile'> </div> </div> </div> </div> </script> <script type='text/x-red' data-help-name='modbus-getter'>
 <p><strong>
