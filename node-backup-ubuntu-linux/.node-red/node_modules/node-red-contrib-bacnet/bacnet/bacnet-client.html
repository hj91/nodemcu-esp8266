...
for='node-config-input-port'><i class='icon-tag'></i> <span data-i18n='bacnet-contrib.label.port'></span></label> 
<input type='text' id='node-config-input-port' placeholder='47808'> </div> <div class='form-row'> <label 
for='node-config-input-adpuTimeout'><i class='icon-tag'></i> <span data-i18n='bacnet-contrib.label.adpuTimeout'></span>
</label> <input type='text' id='node-config-input-adpuTimeout' placeholder='6000'> </div> 
</script> <script type='text/x-red' data-help-name='BACnet-Client'>
 <h2>BACnet Client node</h2> <h3>BETA</h3> <a href='https://fh1ch.github.io/node-bacstack/' target='_blank'>API Docs
</a>
