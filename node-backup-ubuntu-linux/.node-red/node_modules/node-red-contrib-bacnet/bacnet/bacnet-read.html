...
<div class='form-row'> <h4>Properties</h4> <hr> </div> <div class='form-row'> <label for='node-input-propertyId'><i 
...
</script> <script type='text/x-red' data-help-name='BACnet-Read'>
...
Multiple Read</h3> <h4>Input</h4> <p>msg.payload.deviceIPAddres</p> <strong>msg.payload.requestArray</strong> <i>
...
Array of objects with property:</i> <p>id</p> <p>Example of msg.payload.requestArray:</p> <pre>
    ...
    </pre> <p>msg.payload.propertyId</p> <strong>
msg.payload.options (all optional)</strong> <p>msg.payload.options.maxSegments</p> <p>msg.payload.options.maxAdpu</p> 
<p>msg.payload.options.invokeId</p> <p>msg.payload.options.arrayIndex</p> <h3>Simple Read</h3> <h4>Input</h4> <p>
msg.payload.deviceIPAddres</p> <strong>msg.payload.objectId</strong> <p>msg.payload.objectId.type</p> <p>
msg.payload.objectId.instance</p> <p>msg.payload.propertyId</p> <strong>msg.payload.options (all optional)</strong> <p>
msg.payload.options.maxSegments</p> <p>msg.payload.options.maxAdpu</p> <p>msg.payload.options.invokeId</p> <p>
msg.payload.options.arrayIndex</p> <pre>
        objectId: {type: 8, instance: 44301}
        propertyId: 28
    </pre>
 <h3>All Modes</h3> <h4>Output</h4> <p>msg.payload</p> 
</script> 