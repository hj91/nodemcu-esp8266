...
class='fa fa-search'></i></a> </div> <div class='form-row'> <label for='node-input-instance'><i class='icon-globe'></i>
 <span data-i18n='bacnet-contrib.label.instance'></span></label> <input type='text' id='node-input-instance'> </div> 
<div class='form-row'> <h4>Value</h4> <hr> </div> <div class='form-row'> <label for='node-input-valueTag'><i 
...
style='width:60%' placeholder='8'> <a id='node-lookup-propertyId' class='btn'><i id='node-lookup-topic-icon' 
class='fa fa-search'></i></a> </div> <div class='form-row'> <hr> <h4>Device and Interface</h4> <hr> </div> <div 
class='form-row'> <label for='node-input-device'><i class='icon-globe'></i> <span 
...
class='form-row'> <label style='min-width:160px' for='node-input-multipleWrite'><i class='fa fa-th'></i> <span 
data-i18n='bacnet-contrib.label.multipleWrite'></span></label> <input type='checkbox' id='node-input-multipleWrite' 
style='max-width:30px'> </div> 
</script> <script type='text/x-red' data-help-name='BACnet-Write'>
...
Multiple Write</h3> <h4>Input</h4> <p>msg.payload.deviceIPAddres</p> <strong>msg.payload.values</strong> <i>
...
</pre> <p>priority</p> <strong>msg.payload.options (all optional)</strong> <p>msg.payload.options.maxSegments</p> <p>
msg.payload.options.maxAdpu</p> <p>msg.payload.options.invokeId</p> <h3>Simple Write</h3> <h4>Input</h4> <p>
msg.payload.deviceIPAddres</p> <strong>msg.payload.objectId</strong> <p>msg.payload.objectId.type</p> <p>
...
</pre> <h3>All Modes</h3> <h4>Output</h4> <p>msg.payload</p> 
</script> 