...
for='node-input-singleBrowseResult'><i class='fa fa-object-group'></i> <span 
...
data-help-name='OPCUA-IIoT-Browser'> <h2>OPC UA IIoT Browser</h2> <p>
...
With the single result option you get less msg objects from the Browser node. The delay per msg option helps to get some time between every msg outputs.
