...
RED.nodes.registerType("OPCUA-IIoT-Discovery",{category:"IIoT",color:"#ABCDEF",defaults:{name:{value:""},discoveryPort:{value:4840}},inputs:1,outputs:1,align:"left",icon:"icon.png",label:function(){return this.name||"Discovery"},labelStyle:function(){return this.name?"node_label_italic":""}})
