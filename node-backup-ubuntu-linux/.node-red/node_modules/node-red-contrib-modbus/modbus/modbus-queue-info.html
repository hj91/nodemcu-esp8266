...
for='node-input-errorOnHighLevel'><i class='fa fa-th'></i> <span data-i18n='modbus-contrib.label.errorOnHighLevel'>
</span></label> <input type='checkbox' id='node-input-errorOnHighLevel' style='max-width:30px'> </div> </script> <script
 type='text/x-red' data-help-name='modbus-queue-info'>
