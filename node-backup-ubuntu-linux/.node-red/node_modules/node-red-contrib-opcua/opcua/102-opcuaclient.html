...
<script type="text/x-red" data-template-name="OpcUa-Client">
	...
	<div class="form-row">
        <label for="node-input-path"><i class="icon-tasks"></i> Path to certificates</label>
        <input type="text" id="node-input-path" placeholder="../../../node_modules/node-opcua-client/certificates/">
    </div>
    <div class="form-row">
