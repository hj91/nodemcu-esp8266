...
RED.nodes.registerType("OPCUA-IIoT-Listener",{category:"IIoT",color:"#ABCDEF",defaults:{connector:{type:"OPCUA-IIoT-Connector",required:!0},action:{value:"subscribe",required:!0},queueSize:{value:10,required:!0,validate:RED.validators.number()},name:{value:""},topic:{value:""},justValue:{value:!0},useGroupItems:{value:!1},showStatusActivities:{value:!1},showErrors:{value:!1}},inputs:1,outputs:1,align:"left",icon:"icon.png",label:function(){return this.name||"Listener"},labelStyle:function(){return this.name?"node_label_italic":""}})
