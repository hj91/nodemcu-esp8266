...
<li>Basic256Sha256</li> </ul> </div> <div class='form-row'> <!-- MessageSecurityMode enum via REST --> <label 
for='node-input-securityMode' style='min-width:140px'><i class='fa fa-key'></i> <span 
data-i18n='opcua-iiot-contrib.label.securityMode'></span></label> <ul style='margin-left:80px'> <li>None</li> <li>Sign
</li> <li>Sign&Encrypt</li> </ul> </div> <div class='form-row'> <label style='min-width:140px'> <i 
...
<div class='form-row'> <label for='node-input-publicCertificateFile'><i class='fa fa-file'></i> <span 
...
style='min-width:480px'> </div> <hr> </div> <div class='form-row'> <label for='node-input-allowAnonymous' 
