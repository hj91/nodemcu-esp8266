...
export interface UAVariable extends BaseNode, VariableAttributes, IPropertyAndComponentHolder {
    ...
    writeValue(context: SessionContext, dataValue: DataValue, indexRange: string | NumericRange | null, callback: StatusCodeCallBack): void;
    writeValue(context: SessionContext, dataValue: DataValue, callback: StatusCodeCallBack): void;
    writeValue(context: SessionContext, dataValue: DataValue, indexRange?: string | NumericRange | null): Promise<StatusCode>;
...
export interface UAVariableT<T> extends UAVariable {
    readValue(context?: SessionContext, indexRange?: NumericRange, dataEncoding?: QualifiedNameLike | null): DataValueT<T>;
    writeValue(context: SessionContext, dataValue: DataValueT<T>, indexRange: NumericRange | null, callback: (err: Error | null, statusCode?: StatusCode) => void): void;
    writeValue(context: SessionContext, dataValue: DataValueT<T>, callback: (err: Error | null, statusCode?: StatusCode) => void): void;
    writeValue(context: SessionContext, dataValue: DataValueT<T>, indexRange?: NumericRange | null): Promise<StatusCode>;
}
