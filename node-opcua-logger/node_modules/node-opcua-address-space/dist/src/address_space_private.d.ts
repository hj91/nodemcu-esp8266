...
import { AddReferenceOpts, AddressSpace, BaseNode as BaseNodePublic, UADataType, UAView } from "../source";
...
export interface AddressSpacePrivate extends AddressSpace {
    ...
    _coerceType(baseType: string | NodeId | BaseNodePublic, topMostBaseType: string, nodeClass: NodeClass): UAVariableType | UAObjectType;
