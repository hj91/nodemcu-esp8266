...
function _setAckedState(self, requestedAckedState, eventId, comment) {
    node_opcua_assert_1.assert(self instanceof condition_snapshot_1.ConditionSnapshot);
...
function prepare_date(sourceTimestamp) {
    ...
    node_opcua_assert_1.assert(sourceTimestamp.value instanceof Date);
