 ...
 *
 */
export declare class UASystemOffNormalAlarm extends UAOffNormalAlarm {
    static instantiate(namespace: Namespace, limitAlarmTypeId: string | NodeId, options: any, data: any): UASystemOffNormalAlarm;
}
