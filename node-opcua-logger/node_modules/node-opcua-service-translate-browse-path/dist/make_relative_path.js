 ...
 */
const hierarchicalReferenceTypeNodeId = node_opcua_nodeid_1.resolveNodeId("HierarchicalReferences");
const aggregatesReferenceTypeNodeId = node_opcua_nodeid_1.resolveNodeId("Aggregates");
...
function makeRelativePath(str, addressSpace) {
    ...
    while (str.length > 0) {
        ...
        if (refStr === "/") {
            ...
            if (!matches[6]) {
                referenceTypeId = node_opcua_nodeid_1.resolveNodeId(name);
            }
            else {
            ...
            node_opcua_assert_1.assert(referenceTypeId && !referenceTypeId.isEmpty());
        }
